...
const Signin = () => {
  ...
  return (
    ...
    >
      ...
      <form className="relative z-10 w-[90%] h-[300px] max-w-[500px] bg-white/20 backdrop-blur-md shadow-xl shadow-blue-900/30 flex flex-col justify-center items-center gap-[20px] px-[20px] rounded-2xl">
        <h1 className="text-white text-[30px] font-semibold font-serif mt-[50px] text-center">
          Sign In To{" "}
          <span className="text-yellow-400">Rathod Cabs And Travels</span>
        </h1>

        <input
          type="email"
          placeholder="Email"
          className="w-full h-[60px] outline-0 border-2 border-white bg-transparent text-black placeholder-black px-[20px] py-[10px] rounded-full text-[15px]"
        />
        ...
        <div className="w-full h-[60px] relative">
          <input
            ...
            className="w-full h-full outline-0 border-2 border-white bg-transparent text-black placeholder-black px-[20px] py-[10px] rounded-full text-[15px]"
          />

          {showpassword ? (
            <IoEyeOff
              className="absolute bottom-[9px] right-[40px] text-white w-[25px] h-[25px] cursor-pointer"
        ...
        <button
          type="button"
          className="min-w-[130px] h-[50px] bg-white rounded-full mt-[20px] text-[19px] font-bold "
        >
          Sign In
        </button>
