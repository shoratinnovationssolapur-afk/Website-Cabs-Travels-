...
const UserBookings = () => {
  ...
  if (loading) {
    return <div className="p-8 md:p-10 text-center font-bold text-gray-500">Loading your trips...</div>;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-3 sm:p-4 md:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 md:mb-8">
        ...
        <span className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-bold w-fit">
      ...
      {bookings.length === 0 ? (
        <div className="bg-white rounded-3xl p-8 md:p-12 text-center border-2 border-dashed border-gray-200">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-800">No bookings found</h2>
          <p className="text-gray-500 mt-2 text-sm md:text-base">
            Ready to hit the road? Your future trips will appear here.
          </p>
        </div>
      ) : (
